import { Component, ViewChild, Renderer2, ElementRef, ChangeDetectionStrategy, TemplateRef, HostListener, OnInit   } from '@angular/core';
...
@Component({
  ...
  standalone: true,
  imports: [MatDialogModule, MatButtonModule, MatTableModule, CommonModule, DragDropModule, ResizableModule, MatIconModule, CdkDrag, MatProgressSpinnerModule, NgxSkeletonLoaderModule]
})
